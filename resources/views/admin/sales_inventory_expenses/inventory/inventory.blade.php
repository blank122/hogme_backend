...
<body>
	...
	<section id="sidebar">
		...
		<ul class="side-menu top">
			<li>
				<a class="p-0 m-0" href={{ route('admindashboard') }}>
					<i class='bx bxs-dashboard' ></i>
					<span class="text">Dashboard</span>
				</a>
			</li>
			<li>
				<a class="p-0 m-0" href="{{ route('livestockIndex') }}">
			...
			<li>
				<a class="p-0 m-0" href="{{ route('memberIndex') }}">
			...
			<li>
				<a class="p-0 m-0" href="{{ route('announcementIndex') }}">
			...
			<li class="active">
				<a class="p-0 m-0" href="{{ route('inventoryIndex') }}">
