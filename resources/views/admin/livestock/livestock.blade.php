...
<body>
	...
	<section id="sidebar">
		...
		<ul class="side-menu top">
			<li>
				<a class="m-0 p-0" href={{ route('admindashboard') }}>
					<i class='bx bxs-dashboard' ></i>
					<span class="text">Dashboard</span>
				</a>
			</li>
			<li class="active">
				<a class="m-0 p-0" href="{{ route('livestockIndex') }}">
			...
			<li>
				<a class="m-0 p-0" href="{{ route('memberIndex') }}">
			...
			<li>
				<a class="m-0 p-0" href="{{ route('announcementIndex') }}">
			...
			<li>
				<a class="m-0 p-0" href="{{ route('inventoryIndex') }}">
